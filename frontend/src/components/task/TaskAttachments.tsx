    ...
    return (
        <div className="mb-8">
            <div className="flex items-center gap-2 mb-4">
                <h3 className="text-sm font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wide">Attachments</h3>
                <span className="text-gray-400 dark:text-gray-500 text-xs font-medium">· {attachments?.length || 0}</span>
            </div>
                ...
                {attachments?.map((att) => (
                    ...
                    >
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="text-xs font-semibold text-gray-700 dark:text-gray-200 truncate">{att.name}</div>
                            <div className="text-[10px] text-gray-400 dark:text-gray-500 font-medium">Download</div>
                        </div>
