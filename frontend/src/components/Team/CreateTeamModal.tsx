    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-30">
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-[500px] max-w-full m-4 flex flex-col max-h-[90vh]">
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700">
          <h2 className="text-lg font-semibold text-gray-800 dark:text-white">{isEditing ? "Edit Team" : "Create new team"}</h2>
        ...
        <div className="p-6 overflow-y-auto">
          ...
          <div className="mb-5 relative">
            ...
            <Dropdown
              ...
              trigger={
                <button
                  className="w-full flex items-center justify-between px-3 py-2.5 border border-dashed border-gray-300 dark:border-gray-600 rounded-md text-gray-500 dark:text-gray-400 hover:border-gray-400 dark:hover:border-gray-500 bg-white dark:bg-gray-800 transition-colors"
                >
              ...
              items={
                isProjectsLoading
                  ? [{ key: 'loading', custom: true, label: <div className="p-3 text-center text-sm text-gray-400 dark:text-gray-500">Loading projects...</div> }]
                  : projects.length > 0
                    ...
                    : [{ key: 'empty', custom: true, label: <div className="p-3 text-center text-sm text-gray-400 dark:text-gray-500">No projects found</div> }]
              }
            />
          </div>
          ...
          <div className="space-y-4 max-h-[200px] overflow-y-auto">
            <h4 className="text-xs font-medium text-gray-500 dark:text-gray-400 uppercase">Available Members</h4>
            {isMembersLoading ? (
              <div className="text-center py-4 text-gray-400 dark:text-gray-500 text-sm">Loading members...</div>
                ...
                return (
                  ...
                  >
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <h4 className="text-sm font-semibold text-gray-800 dark:text-white">{member.name}</h4>
                        <p className="text-xs text-gray-500 dark:text-gray-400">{member.position}</p>
                      </div>
                    </div>
                    <button className={`flex items-center gap-1 text-xs font-medium ${isSelected ? 'text-blue-600 dark:text-blue-400' : 'text-gray-400 dark:text-gray-500'}`}>
              ...
              <div className="text-center py-4 text-gray-400 dark:text-gray-500 text-sm">No members found</div>
            )}
          </div>
        </div>
        ...
        <div className="px-6 py-4 border-t border-dashed border-blue-200 dark:border-blue-800">
          <div className="flex items-center gap-3">
            <button
              ...
              className={`px-6 py-2 bg-blue-500 text-white text-sm font-medium rounded-md shadow-sm shadow-blue-200 dark:shadow-blue-900 transition-colors ${isSubmitting || !teamName.trim() ? 'opacity-50 cursor-not-allowed' : 'hover:bg-blue-600'
                }`}
            >
