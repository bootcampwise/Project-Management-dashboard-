    ...
    const designTemplates = [
        {
            ...
            description: "Align project goals, audience insights, and key deliverables for design clarity.",
            type: "Table",
            icon: Table,
            imageColor: "bg-pink-100",
            imageContent: <div className="p-4"><div className="w-1/2 h-4 bg-gray-800 rounded mb-2 font-bold text-xs opacity-50">03:12</div><div className="w-full h-2 bg-gray-300 rounded mb-1"></div><div className="w-3/4 h-2 bg-gray-300 rounded"></div></div>
        },
        {
            title: "Design Sprint",
            description: "Plan and track each phase of rapid design sprints for innovative solutions.",
            type: "Calendar",
            icon: Calendar,
            imageColor: "bg-purple-100",
            imageContent: <div className="flex items-center justify-center h-full"><div className="w-12 h-12 rounded-full border-4 border-yellow-400 flex items-center justify-center bg-white font-bold">9</div></div>
        },
        {
            title: "Brand Guidelines",
            description: "Centralize brand colors and visuals for consistent design applications.",
            type: "Board",
            icon: Layout,
            imageColor: "bg-green-100",
            imageContent: <div className="p-4 grid grid-cols-2 gap-2"><div className="h-10 bg-green-200 rounded"></div><div className="h-10 bg-green-300 rounded"></div></div>
        },
        {
            title: "Wireframe & Prototyping",
            description: "Organize wireframes and prototypes to refine design concepts efficiently.",
            type: "Table",
            icon: Table,
            imageColor: "bg-red-100",
            imageContent: <div className="p-4 space-y-2"><div className="flex gap-2"><div className="w-4 h-4 bg-red-400 rounded"></div><div className="w-20 h-4 bg-white rounded"></div></div></div>
        },
        {
            title: "Design Feedback",
            description: "Collect structured feedback to streamline revisions and approvals.",
            type: "Board",
            icon: Layout,
            imageColor: "bg-yellow-50",
            imageContent: <div className="p-4"><div className="w-full h-full border-2 border-dashed border-gray-300 rounded flex items-center justify-center text-gray-400 text-xs">Feedback</div></div>
        },
        {
            title: "Asset Library",
            description: "Manage design assets, ensuring easy access and version control.",
            type: "Calendar",
            icon: Calendar,
            imageColor: "bg-blue-100",
            imageContent: <div className="p-4 flex gap-2"><div className="w-8 h-10 bg-white shadow rounded"></div><div className="w-8 h-10 bg-white shadow rounded"></div></div>
        }
    ];
                ...
                <div className="w-[280px] bg-[#F9FAFB] border-r border-gray-200 flex flex-col p-5 h-full">
                    ...
                    <div className="flex-1 overflow-y-auto space-y-1">
                        {categories.map((category) => (
                            ...
                            >
                                <category.icon size={20} className={category.color} strokeWidth={2} />
                ...
                <div className="flex-1 flex flex-col bg-white">
                    ...
                    <div className="flex items-center justify-between px-10 py-6 border-b border-gray-100 min-h-[88px]">
                        <div className="flex items-center gap-3">
                            ...
                            {isDesign ? <Palette className="text-yellow-600" size={24} /> : <Rocket className="text-orange-500 fill-orange-500" size={28} />}
                        ...
                        {isDesign ? (
                            <div className="grid grid-cols-3 gap-6">
                                {designTemplates.map((template, index) => (
                                    <div key={index} className="group cursor-pointer flex flex-col h-full border border-gray-100 rounded-xl hover:shadow-lg transition-shadow duration-200 overflow-hidden bg-white">
                                        {/* Preview Image */}
                                        <div className={`h-32 ${template.imageColor} relative overflow-hidden p-2`}>
                                            {template.imageContent}
                                        </div>

                                        {/* Content */}
                                        <div className="p-4 flex flex-col flex-1">
                                            <h3 className="text-base font-semibold text-gray-800 mb-2">{template.title}</h3>
                                            ...
                                            <div className="flex items-center gap-2 text-gray-400 mt-auto">
                                                ...
                                                <span className="text-[11px] font-medium">{template.type}</span>
                                            </div>
                                        </div>
                                    </div>
                                ))}
