      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-100 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50">
        <div className="flex items-center gap-2">
          <h2 className="text-base font-semibold text-gray-700 dark:text-gray-200 flex items-center gap-2">
            ...
            {viewMode === 'month' && <ChevronDown size={14} className="text-gray-400 dark:text-gray-500" />}
          </h2>
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-1 text-gray-400 dark:text-gray-500">
            <button onClick={handlePrev} className="p-1 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
              <ChevronLeft size={16} />
            </button>
            <button onClick={handleNext} className="p-1 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded">
          ...
          <div className="grid grid-cols-7 gap-y-12">
            {calendarDays.map((day) => {
              ...
              return (
                ...
                >
                  {/* Date Number */}
                  <div className={`text-[11px] text-right mb-2 pr-2 ${isToday ? '' : 'text-gray-500 dark:text-gray-400'}`}>
                    {isToday ? (
        ...
        <div className="flex-1 p-8 overflow-y-auto bg-white dark:bg-gray-900">
          ...
          {isLoading ? (
            ...
            <div className="text-center py-10 text-gray-400 dark:text-gray-500">
              ...
              <button className="mt-4 text-blue-600 dark:text-blue-400 hover:underline text-sm">Add an event</button>
            </div>
          ) : (
              ...
              {getEventsForDay(currentDate).map(event => (
                ...
                >
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <span className="font-medium text-base text-gray-900 dark:text-white">{event.title}</span>
                      {event.description && (
